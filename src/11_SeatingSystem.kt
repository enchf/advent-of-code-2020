 ...
 * The other rules still apply: empty seats that see no occupied seats become occupied, s
 * eats matching no rule don't change, and floor never changes.
 *
...
fun GameOfLife<String>.occupiedSeats() = matrix.map { row -> row.count { it == "#" } }.sum()
